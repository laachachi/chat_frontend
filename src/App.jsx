...
const App = () => {
    ...
    const handleAsk = async () => {
        ...
        try {
            const res = await axios.post("https://humble-space-couscous-p6j9jxq6vprh646j-5000.app.github.dev/chat", { question } , 
                {
                    headers: {
                      "Content-Type": "application/json"
                    },
                    withCredentials: false , 
                    timeout : 10000   // mettre à true si cookies/session
                  }
            );
